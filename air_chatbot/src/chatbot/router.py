...
class QueryIntent(BaseModel):
    type: QueryType  # Single type only
    confidence: float
...
class RouterChain:
    def __init__(self, llm: ChatOpenAI):
        self.llm = llm
        self.last_query_type = None  # Track single last type
        self.history = InteractionHistory(max_size=5)  # Track last 5 interactions
